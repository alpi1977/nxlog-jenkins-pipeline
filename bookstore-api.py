...
app.config['MYSQL_DATABASE_USER'] = 'projectuser'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Projectpassword_1'
...
# Write a function named `home` which returns 'Welcome to the Developer's Bookstore API Service V2',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Developer's Bookstore API Service V2"
